...
class Controller : IController
{
    ...
    var commandMap: Dictionary<String,String>
    var view: IView?
    ...
    */
    init ()
    {
        ...
        self.commandMap = Dictionary<String,String>()
    ...
    */
    func executeCommand ( notification: INotification )
    {
        ...
        var commandClassRef : String = self.commandMap[ notification.name! ]!;
        
        if ( commandClassRef.isEmpty )
        {
            return;
        }
    ...
    */
    func registerCommand ( notificationName: String , commandClassRef: String )
    {
        if ( self.commandMap[ notificationName ]!.isEmpty )
        {
        ...
        self.commandMap.updateValue( commandClassRef , forKey: notificationName )
    ...
    */
    func removeCommand( notificationName: String )
    {
        if ( self.hasCommand( notificationName ))
        {
            ...
            self.commandMap.updateValue( "" , forKey: notificationName )
